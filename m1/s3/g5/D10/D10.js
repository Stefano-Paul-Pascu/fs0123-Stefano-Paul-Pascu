...
function whoIsBigger(numero, numero1) {
  if (numero > numero1) {
    return numero;
  } else {
    return numero1;
...
console.log(whoIsBigger(numero, numero1));
...
/*function isThisAnEmail(stringa) {
  const emailRegex = /[a-z0-9.+-]+@[a-z0-9.-]+.[a-z]{2,8}/;
  return emailRegex.test(stringa);
}

console.log(isThisAnEmail('tizio@caio.it'));
...
/*function isTodayMyBirthday() {
  ...
  const mese = 11; 
  const giorno = 24;
  if (oggi.getMonth() === mese && oggi.getDate() === giorno) {
    return true;
  } else {
    return false;
  }
